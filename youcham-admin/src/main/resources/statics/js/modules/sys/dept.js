...
Dept.initColumn = function () {
    var columns = [
        ...
        {title: '企业名称', field: 'name', align: 'center', valign: 'middle', sortable: true, width: '180px'},
        {title: '上级企业', field: 'parentName', align: 'center', valign: 'middle', sortable: true, width: '100px'},
        {title: '企业代号', field: 'code', align: 'center', valign: 'middle', sortable: true, width: '100px'},
        // {title: '部门性质', field: 'levelDesc', align: 'center', valign: 'middle', sortable: true, width: '100px'},
        {title: '状态', field: 'statusDesc', align: 'center', valign: 'middle', sortable: true, width: '80px'},

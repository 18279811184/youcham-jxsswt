...
import io.youcham.modules.sys.entity.SysRoleEntity;
import io.youcham.modules.sys.service.SysRoleDeptService;
import io.youcham.modules.sys.service.SysRoleMenuService;
import io.youcham.modules.sys.service.SysRoleService;
...
public class SysRoleController extends AbstractController {
	...
	public R delete(@RequestBody String[] roleIds){
		String[] systemIds = {"1","2","3","4","5","6","7"};
		for (String id : roleIds) {
			if(Arrays.asList(systemIds).contains(id)){
				return R.error("角色ID["+id+"], 系统角色不可删除");
			}
		}

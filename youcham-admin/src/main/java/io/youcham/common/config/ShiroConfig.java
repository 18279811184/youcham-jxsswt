...
import io.youcham.modules.sys.shiro.UserRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        filterMap.put("/not_permission.html", "anon");
        //登录测试页面
        filterMap.put("/modules/loginindex/**", "anon");
        filterMap.put("/sys/login", "anon");
        filterMap.put("/sys/user/register", "anon");
        filterMap.put("/favicon.ico", "anon");
        filterMap.put("/captcha.jpg", "anon");
        //微信页面
        filterMap.put("/modules/mobile/**", "anon");
        //微信小程序接口
        filterMap.put("/api/**", "anon");



        filterMap.put("/fileAction/**", "anon");
        //结束
        filterMap.put("/**", "authc");
